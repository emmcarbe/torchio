...
const STRINGS = {
  en: {
    ...
    apparatusCritical: 'critical: variants between witnesses', apparatusGenetic: 'genetic: the strata of one manuscript in time',
  ...
  it: {
    ...
    apparatusCritical: 'critico: varianti tra testimoni', apparatusGenetic: 'genetico: gli strati di un manoscritto nel tempo',
