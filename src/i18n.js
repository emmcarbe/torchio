...
const STRINGS = {
  en: {
    ...
    mapNote: 'Positional sketch. Filled dots: coordinates declared in the TEI or confirmed by the editor. Hollow dots: gazetteer suggestions awaiting review. Each place links to OpenStreetMap.',
  ...
  it: {
    ...
    mapNote: 'Schizzo posizionale. Punti pieni: coordinate dichiarate nel TEI o confermate dall\u2019editore. Punti vuoti: suggerimenti del gazetteer in attesa di revisione. Ogni luogo rimanda a OpenStreetMap.',
