...
const STRINGS = {
  en: {
    ...
    lexAbs: 'count', lexRel: 'per 1000', lexStopCol: 'stop', lexStopNote: 'Frequencies and cloud drop the stopwords you choose; the concordance keeps every word.',
  ...
  it: {
    ...
    lexAbs: 'assoluta', lexRel: 'per 1000', lexStopCol: 'stop', lexStopNote: 'Frequenze e nuvola tolgono le stopword scelte; la concordanza tiene ogni parola.',
